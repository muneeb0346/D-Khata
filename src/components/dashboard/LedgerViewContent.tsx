    ...
    <article className="flex-col h-full" aria-live="polite">
      <header className={headerStyles.header}>
        <div className="flex-row justify-between gap-md">
          <Button variant="secondary" onClick={onBack} className={wAutoStyles['w-auto']} aria-label="Go back to customer list">
            ← Back
          </Button>
          <Button variant="secondary" onClick={onShare} className={`${wAutoStyles['w-auto']} flex-row items-center gap-sm`} aria-label="Share ledger link via WhatsApp">
