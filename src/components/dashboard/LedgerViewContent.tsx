    ...
    <article className="flex-col h-full" aria-live="polite">
      <header className={headerStyles.header}>
        <div className="flex-row justify-between gap-md">
          ...
          <Button
            variant="secondary"
            onClick={onShare}
            className={`${wAutoStyles["w-auto"]} flex-row items-center gap-sm`}
            aria-label="Share ledger link via WhatsApp"
          >
      ...
      <section className="txns-container" aria-label="Transactions">
        ...
        <section className="p-md" aria-label="Customer details">
          <div className={`flex-row justify-between ${styles["items-center"]} mb-md`}>
          ...
          <dl className="card-base flex-col gap-sm">
            ...
            <div className="mt-md">
              <Button
                ...
                aria-label="Copy customer details to clipboard for filing a case"
              >
      ...
      <footer className="flex-row gap-md sticky-bottom">
        <Button
          ...
          disabled={isLocked}
          aria-label={
            isLocked ? "Cannot add credit while account is locked" : "Add a new credit transaction"
          }
        >
          Add Credit
        </Button>
        <Button
          ...
          aria-label={
            isLocked
              ? "Cannot receive payment while account is locked"
